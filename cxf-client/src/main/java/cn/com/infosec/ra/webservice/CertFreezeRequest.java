...
@XmlRootElement(name = "certFreezeRequest")
public class CertFreezeRequest {

    @XmlElement(required = true)
    protected String transactionCode;
    @XmlElement(required = true)
    protected CertFreezeRequest.Parameters parameters;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link CertFreezeRequest.Parameters }
     *     
     */
    public CertFreezeRequest.Parameters getParameters() {
        return parameters;
    }
     ...
     *     
     */
    public void setParameters(CertFreezeRequest.Parameters value) {
